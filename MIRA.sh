...
Primer Schema options for RSV: RSV_CDC_8amplicon_230901, dong_et_al, davina_nunez_wgs" 1>&2
	exit 1
}
...
while getopts 's:r:e:p:c:i:na' OPTION; do
	case "$OPTION" in
...
for eachdir in ${bbtools_path}; do
