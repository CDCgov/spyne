...
Usage in git cloned CLI: \n bash $0 -s {path to samplesheet.csv } -r <run_id > -e <experiment_type> <OPTIONAL: -p amplicon_library> <OPTIONAL: -i flu_sensitive> <optional: -c CLEANUP-FOOTPRINT> <optional: -n > \n \
